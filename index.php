...
<div id="dashboard col-sm-12">  
    ...
    <div class="profile-completion-section col-sm-12">
        ...
        <div class="complete-profile">
            <a href="#">Complete your profile <span class="fa fa-angle-right"></span></a>
        </div>
    </div>  
    ...
    <div class="curent-assignment-section col-sm-12">
        <div class="assignment-completion-header">
            ...
            <div class="details">
            <div class="company"><span class="fa fa-group"></span>ScanCommcerce A/S</a></div>
                <div class="email"><a href="mailto:someone@example.com?Subject=Hello%20again" target="_top"><span class="fa fa-envelope"></span>adv@scancommerce.dk</a></div>
            </div>
        </div>
